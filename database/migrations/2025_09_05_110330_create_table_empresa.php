...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('empresas', function (Blueprint $table) {
            ...
            $table->string('sunat_client_id', 250)->nullable();
            $table->string('sunat_secret_id', 250)->nullable();
            $table->string('key_publica', 250)->nullable();
            $table->string('key_privada', 250)->nullable();
